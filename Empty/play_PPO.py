...
class play:
    ...
    def parameter(self):
        ...
        desktop_path =  'Empty/saved_networks/'+self.PPO.date_time+'/'  # 新创建的txt文件的存放路径
        ...
        while True:
            ...
            if self.progress == 'Training':
                ...
                if (step_for_newenv+1)%self.Num_batch==0 or terminal == True:
                    ...
                    buffer_state,buffer_image,buffer_a, buffer_r =  [], [],[],[]
                    with open('Empty/saved_networks/'+self.PPO.date_time+'/value.txt','a') as f:             
                        f.write('reward')
                        f.write('\r')
            ...
            if terminal == True:
                ...
                if self.progress == 'Training':
                    ...
                    # ------------------------------
                    np.savetxt('Empty/saved_networks/'+self.PPO.date_time+'/Reward.txt', reward_array, delimiter=',')
                    # ------------------------------
